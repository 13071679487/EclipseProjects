 ...
 * generated in the com.rifu.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCity_QNAME = new QName("http://service.rifu.com/", "getWeatherByCity");
    private final static QName _GetWeatherByCityResponse_QNAME = new QName("http://service.rifu.com/", "getWeatherByCityResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rifu.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.rifu.com/", name = "getWeatherByCity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.rifu.com/", name = "getWeatherByCityResponse")
