 ...
 * 2018-05-01T11:50:20.488+08:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "WeatherServiceService",
                  wsdlLocation = "http://192.168.1.102:12345/weather?wsdl",
                  targetNamespace = "http://service.rifu.com/")
public class WeatherServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.rifu.com/", "WeatherServiceService");
    public final static QName WeatherServicePort = new QName("http://service.rifu.com/", "WeatherServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.1.102:12345/weather?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherServiceService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.1.102:12345/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
