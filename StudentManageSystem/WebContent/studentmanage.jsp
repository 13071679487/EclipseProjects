...
<script type="text/javascript">
	...
	function searchStudent(){
		/**
		下拉框取值
		$('#控件id').combobox("getValue");
		*/
		
		
		/**
		日期控件取值
		$('#控件id').datebox("getValue");
		*/
		$('#dg').datagrid('load',{
			s_stuNo:$('#s_stuNo').val(),
	...
	<table id="dg" title="班级信息" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="gradeId" width="100">班级</th>
				<th field="email" width="100">邮箱</th>
				<th field="stuDesc" width="250">备注</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>
			&nbsp;学号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo"
				size="10" /> 
				&nbsp;姓名：&nbsp;<input type="text" name="s_stuName"
				id="s_stuName" size="10" /> 
				&nbsp;性别：&nbsp;
				<select
				...
				id="s_birthday" editable="false" size="10" /> 
				&nbsp;所属班级：&nbsp;<input
				class="easyui-combobox" id="s_gradeId" name="s_gradeId" size="10"
				data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'gradeName'" />
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>班级名称：</td>
					<td><input
				class="easyui-combobox" id="gradeId" name="gradeId" size="10"
				data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'gradeName'" /></td>
					<td></td>
					<td>Email：</td>
