...
<body style="margin: 5px">
	<table id="dg" title="班级信息" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="gradeList" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:openGradeModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit"
				plain="true">修改</a> <a href="javascript:deleteGrade()"
				class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
		</div>
		<div>
			&nbsp;<input type="text" name="gradeName" id="gradeName"
				title="请输入要搜索的班级" /> <a href="javascript:searchGrade()"
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px; height: 280px"
		...
		<table>
				...
				<tr>
					...
					<td><textarea rows="3" cols="30" name="gradeDesc" id="gradeDesc"></textarea></td>
				</tr>
			</table>
		</form>	
	</div>
