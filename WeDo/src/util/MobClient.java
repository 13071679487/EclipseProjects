...
//	public static String REQ_METHOD_TRACE = "TRACE";
    ...
    public  static String requestData2(String address ,String params){
		...
		//get result 
		if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
			MobClient mobClient=new MobClient(address); 
			String result = mobClient.parsRtn(conn.getInputStream());
			return result;
		} else {
