...
/**
 * 个人的任务分配
 * 使用TaskListener的方式设置Assignee
 * @author Lifu
 *
 */
public class PersonalTaskAssign2 {
	...
	public void testDeploy() {
		Deployment deployment = pe.getRepositoryService() // 获取到service
				...
				.addClasspathResource("diagrams/StudentLeaveProcessTaskAssign2.bpmn") // 加载静态资源
																	// .bpmn文件
				.addClasspathResource("diagrams/StudentLeaveProcessTaskAssign2.png") // 加载静态资源
																	// .bpmn文件对应的.png文件
	...
	@Test
	public void start(){
		ProcessInstance pi = pe.getRuntimeService().startProcessInstanceByKey("studentleaveProcessTaskassign2");
