...
public class MultiPersonalTaskAssign {
	...
	public void testDeploy() {
		Deployment deployment = pe.getRepositoryService() // 获取到service
				...
				.addClasspathResource("diagrams/StudentLeaveProcessMultiTaskAssign.bpmn") // 加载静态资源
																	// .bpmn文件
				.addClasspathResource("diagrams/StudentLeaveProcessMultiTaskAssign.png") // 加载静态资源
																	// .bpmn文件对应的.png文件
				.name("学生请假流程多人任务分配") // 设置流程名称
				.deploy();
