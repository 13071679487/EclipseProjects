...
public class ExclusiveGateWay {
	...
	public void testDeploy() {
		Deployment deployment = pe.getRepositoryService() // 获取到service
				...
				.addClasspathResource("diagrams/StudentLeaveProcessWithControl2.bpmn") // 加载静态资源
																	// .bpmn文件
				.addClasspathResource("diagrams/StudentLeaveProcessWithControl2.png") // 加载静态资源
																	// .bpmn文件对应的.png文件
				.name("学生请假流程排他网关") // 设置流程名称
				.deploy();
	...
	@Test
	public void start(){
		ProcessInstance pi = pe.getRuntimeService().startProcessInstanceByKey("studentleaveProcessWithGateway2");
	...
	public void finishProcessAndSetVariables() {
		try {
			...
			pe.getTaskService() // 任务相关Service
					.complete("77504",variables); // 指定要完成的任务ID
		} catch (Exception e) {
			System.out.println("This task is not exeist");
			e.printStackTrace();
		}
